...
GRAPHY_EXPORT HANDLE  OpenFigure(RECT *rt, const CSignals &data, int devID=0);
GRAPHY_EXPORT HANDLE  OpenFigure(RECT *rt, const char* caption, const CSignals &data, int devID=0);
