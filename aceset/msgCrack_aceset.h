...
#define     SetDlgMsgResult(hwnd, msg, result) (( \
        ...
        (msg) == WM_INITDIALOG             \
    ) ? (BOOL)(result) : (SetWindowLong((hwnd), DWL_MSGRESULT, (LONG)(LPARAM)(LRESULT)(result)), TRUE))
...
//void onOpenMap(char* mapfilefull, InterfaceType iProc)
#define HANDLE_WM__OPEN_MAP(hwnd, wParam, lParam, fn) \
    ((fn)((char*)wParam, (InterfaceType)lParam), 0L)
