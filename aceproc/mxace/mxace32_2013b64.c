...
#include <stdio.h>
#define EXPORTING_mxace32_2013b64 1
#include "mxace32_2013b64.h"
    ...
    mclOutputHandlerFcn print_handler)
{
  ...
  if (!mclmcrInitialize())
    return false;
  if (!GetModuleFileName(GetModuleHandle("mxace32_2013b64"), path_to_dll, _MAX_PATH))
    return false;
    {
...
{
  return mxace32_2013b64InitializeWithHandlers(mclDefaultErrorHandler, 
...
LIB_mxace32_2013b64_C_API 
bool MW_CALL_CONV mlfShow_p(int nargout, mxArray** out, mxArray* p, mxArray* fname)
{
