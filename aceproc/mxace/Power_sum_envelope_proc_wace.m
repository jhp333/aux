function v = Power_sum_envelope_proc_wace(p, u)

% Power_sum_envelope_proc_wace: Power-sum envelopes for FFT filterbank.
%
% function v = Power_sum_envelope_proc_wace(p, u)
%
% Inputs:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    p = Ensure_field(p, 'bins2take', 0);

	% Weights matrix for combining FFT bins into bands:
	p.weights = zeros(p.num_bands, p.num_bins);
	bin = 2 + p.bins2take(1);	% We always ignore bins 0 (DC) & 1, then plus alpha
