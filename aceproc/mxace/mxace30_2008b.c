...
#include <stdio.h>
#define EXPORTING_mxace30_2008b 1
#include "mxace30_2008b.h"
#ifdef __cplusplus
extern "C" {
#endif

extern mclComponentData __MCC_mxace30_2008b_component_data;
...
LIB_mxace30_2008b_C_API 
bool MW_CALL_CONV mxace30_2008bInitializeWithHandlers(
...
)
{
  ...
  if (!mclmcrInitialize())
    return false;
  if (!GetModuleFileName(GetModuleHandle("mxace30_2008b"), path_to_dll, _MAX_PATH))
    return false;
  if (!mclInitializeComponentInstanceWithEmbeddedCTF(&_mcr_inst,
                                                     &__MCC_mxace30_2008b_component_data,
                                                     true, NoObjectType,
...
{
  return mxace30_2008bInitializeWithHandlers(mclDefaultErrorHandler,
