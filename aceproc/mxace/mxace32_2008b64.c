...
#include <stdio.h>
#define EXPORTING_mxace32_2008b64 1
#include "mxace32_2008b64.h"
#ifdef __cplusplus
extern "C" {
#endif

extern mclComponentData __MCC_mxace32_2008b64_component_data;
...
LIB_mxace32_2008b64_C_API 
bool MW_CALL_CONV mxace32_2008b64InitializeWithHandlers(
...
)
{
  ...
  if (!mclmcrInitialize())
    return false;
  if (!GetModuleFileName(GetModuleHandle("mxace32_2008b64"), path_to_dll, _MAX_PATH))
    return false;
  if (!mclInitializeComponentInstanceWithEmbeddedCTF(&_mcr_inst,
                                                     &__MCC_mxace32_2008b64_component_data,
                                                     true, NoObjectType,
                                                     LibTarget, error_handler,
                                                     print_handler, 218559, path_to_dll))
    return false;
  return true;
}
...
{
  return mxace32_2008b64InitializeWithHandlers(mclDefaultErrorHandler,
