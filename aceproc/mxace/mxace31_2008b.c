...
#include <stdio.h>
#define EXPORTING_mxace31_2008b 1
#include "mxace31_2008b.h"
#ifdef __cplusplus
extern "C" {
#endif

extern mclComponentData __MCC_mxace31_2008b_component_data;
...
LIB_mxace31_2008b_C_API 
bool MW_CALL_CONV mxace31_2008bInitializeWithHandlers(
...
)
{
  ...
  if (!mclmcrInitialize())
    return false;
  if (!GetModuleFileName(GetModuleHandle("mxace31_2008b"), path_to_dll, _MAX_PATH))
    return false;
  if (!mclInitializeComponentInstanceWithEmbeddedCTF(&_mcr_inst,
                                                     &__MCC_mxace31_2008b_component_data,
                                                     true, NoObjectType,
                                                     LibTarget, error_handler,
                                                     print_handler, 247947, path_to_dll))
    return false;
  return true;
}
...
{
  return mxace31_2008bInitializeWithHandlers(mclDefaultErrorHandler,
